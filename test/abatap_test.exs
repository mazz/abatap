defmodule AbatapTest do
  ...
  describe "generates_an_avatar/1" do
    ...
    test "returns_iwanthue_dark_avatar" do
      {:ok, filename} =
        Abatap.create_from_initials("john", "doe", palette: :iwanthue)
    ...
    test "returns_google_dark_avatar" do
      {:ok, filename} =
        Abatap.create_from_initials("john", "doe", palette: :google)
    ...
    test "returns_google_dark_avatar_size_1024" do
      {:ok, filename} =
        Abatap.create_from_initials("john", "doe", palette: :google, size: 1024)
